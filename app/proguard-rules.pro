...
#     including our DTOs in com.monarch.app.data.cloud)
...
# com.monarch.app.** keeps them explicit and survives consumer-rule changes.
# Companion lookup + generated serializer() must survive shrinking or every
# Supabase decode throws SerializationException.
-keepclassmembers @kotlinx.serialization.Serializable class com.monarch.app.** {
    static ** Companion;
}
-keepclassmembers class com.monarch.app.** {
    kotlinx.serialization.KSerializer serializer(...);
}
# Generated $$serializer classes are only reached reflectively.
-keep,includedescriptorclasses class com.monarch.app.**$$serializer { *; }
