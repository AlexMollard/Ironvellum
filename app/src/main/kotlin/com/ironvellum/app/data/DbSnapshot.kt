...
object DbSnapshot {
     ...
     */
    fun capture(context: Context, dbName: String = IronvellumDatabase.NAME, today: Long = System.currentTimeMillis()): File? =
        runCatching {
    ...
    fun latest(context: Context, dbName: String = IronvellumDatabase.NAME): File? {
