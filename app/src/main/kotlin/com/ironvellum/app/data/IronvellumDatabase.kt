...
abstract class IronvellumDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        // Equipped crest frame: which catalogue frame the lifter wears on
        ...
        // strongest multiplier; this table is what lets the lifter SEE them.
        ...
        private val MIGRATION_23_24 = object : Migration(23, 24) {
            override fun migrate(db: SupportSQLiteDatabase) {
                ...
                // hold is noise the lifter cannot remove.
                db.execSQL(
         ...
         * uses to undo it: the toggle is still unreleased, so no lifter has
        ...
        /**
         * Renames the top crest frame's catalogue id from "monarch" to
         * "masterwork".
         *
         ...
         * archive written before this release still restores its crest.
         */
         ...
         */
        fun create(context: Context, name: String = NAME): IronvellumDatabase =
            Room.databaseBuilder(context, IronvellumDatabase::class.java, name)
