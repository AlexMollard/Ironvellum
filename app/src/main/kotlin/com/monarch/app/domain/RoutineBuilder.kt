...
import com.monarch.app.domain.MovementDifficulty.FREE_WEIGHT_LOAD
...
/** What the hunter is training for; decides rep bands and slot mix. */
    ...
    private fun pick(
        ...
        val candidates = catalogue
            ...
            .filter {
                ...
                // lifts from isolation for a skill hunter.
        ...
        return candidates.minWithOrNull(
            compareBy(
                ...
                // SKILL: a progression the hunter can actually start at -
