 ...
 *
 * The first implementation used only the STRONGEST relic, which meant a hunter
 * holding ten relics saw nine of them do nothing — owning a thing that has no
 * effect is not a reward. Every relic now counts.
 *
 * They cannot stack at full strength either: a draw can yield a relic and the
 * reachable catalogue runs to dozens, so multiplying them together would take
...
object Relics {
     ...
     * deep vault helps without eclipsing the hunt for a better relic.
     */
