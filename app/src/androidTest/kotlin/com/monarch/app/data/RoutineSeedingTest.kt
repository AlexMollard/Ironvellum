 ...
 * data - an existing hunter's presets survive ensureSeeded on upgrade.
 */
...
class RoutineSeedingTest {
    ...
    @Test
    fun existingHuntersPresetsSurviveEnsureSeeded() = runTest {
        val repo = Repository(db)
        repo.ensureSeeded()
        // A hunter who has been editing her week for months: her own preset,
        ...
        assertNotNull("ensureSeeded must leave an existing hunter's presets alone", surviving)
    ...
    private companion object {
        ...
        const val TEST_DB = "monarch-routine-seeding-test.db"
    }
}
