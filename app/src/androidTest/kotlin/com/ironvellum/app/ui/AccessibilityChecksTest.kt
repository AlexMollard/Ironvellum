...
class AccessibilityChecksTest {
    ...
    private fun returnToNavigation() {
        ...
        repeat(8) {
            if (compose.onAllNodesWithContentDescription("Today")
        ...
        repeat(4) {
            val navPresent = compose.onAllNodesWithContentDescription("Today")
                .fetchSemanticsNodes().isNotEmpty()
     ...
     * invisible to the lifter using one, however good it looks.
     */
    @Test
